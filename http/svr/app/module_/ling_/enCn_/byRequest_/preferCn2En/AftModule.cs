...
namespace nilnul.web.svr.module_.ling_.perRequest_.perferCn2En
{
	/// <summary>
	/// </summary>
	/// 
	...
	public class AftModule
	{
		...
		public const string USER_PREFER_CHINESE_KEY = perRequest_.PreferCnToEn.USER_PREFER_CHINESE_KEY;
